...
public class QueryThreeDAO {
    ...
    public QueryThreeDAO() {
        ...
        this.resultCollection = database.getCollection("EduCostStatQueryThree");
    }

    public List<Document> getTopFiveEconomicStates(int year, String type, String length) {
        ...
        List<Bson> pipeline = Arrays.asList(
                ...
                Aggregates.sort(Sorts.ascending("TotalExpense")), // Sort in ascending order for least expensive
                Aggregates.limit(5)
        );
